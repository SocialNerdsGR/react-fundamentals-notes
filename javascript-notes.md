...
Πριν έπρεπε να δηλώσουμε εμείς την αλλαγή γραμμής.
...
Ακόμη μια πολύ σύνηθες χρήση του spread operator είναι όταν θέλουμε να αλλάξουμε ένα πεδίο από το object δημιουργώντας ένα νέο object (immutability).
